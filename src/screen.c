...
void updateCursor()
{
    ...
    calloutportb(0x3D4, 14);                                                                // CRT Control Register: Select Cursor Location
    calloutportb(0x3D5, temp >> 8);                                                         // Send the high byte across the bus
    calloutportb(0x3D4, 15);                                                                // CRT Control Register: Select Send Low byte
    calloutportb(0x3D5, temp);                                                              // Send the Low byte of the cursor location
}
